...
export const metadata={title:'AMReye.AI · Admin',robots:{index:false,follow:false},openGraph:{title:'AMReye.AI · Admin',description:'Authorized access only.',images:[]},twitter:{images:[]}};
