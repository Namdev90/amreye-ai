...
export function HomeDirectory(){
  ...
  return <section id="home" className="amr-home">
    ...
    <div className="amr-hero">
      ...
      <a className="amr-concept-card" href="/#products"><ArrowUpRight aria-hidden="true"/><h2>AMRST Platform Concept</h2><p>AI-assisted AST measurement and in-depth analysis.</p><small>Proposed platform · Concept illustration</small></a>
    </div>
