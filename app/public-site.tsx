...
export default function SiteShell({initialActive='home'}:{initialActive?:string}){
 ...
 </Suspense></main><footer className="public-footer"><a href="/#about">Contact</a><a href="/#team">Team</a><a href="/#recognition">Recognition</a><small>© {new Date().getFullYear()} AMReye.AI · Prototype project · Synthetic demonstrations</small></footer>
